...
<div
	class="hero relative flex items-center justify-center w-full min-h-screen bg-cover bg-center bg-white py-10"
>
	<div class="container mx-auto p-6 flex flex-col gap-4 lg:gap-16 xl:px-24">
		<div class="text-black flex justify-center items-center flex-col gap-4">
			<h3 class="text-center text-black text-2xl md:text-4xl md-2 md:mb-2 font-semibold">Haji Furoda Mujamalah</h3>
			<h1 class="text-center text-lg md:text-2xl mb-8 max-w-[600px]">
				Prioritas Berangkat Tanpa Antri
			</h1>
		</div>
