				...
				<div class="flex gap-4 justify-between items-end pr-8">
					...
					<div class="flex justify-start items-end gap-4">
						<a
							...
							target="_blank"
							class=" h-12 w-auto flex justify-end items-center hover:text-blue-700"
						>
							<svg
								width="24"
								height="auto"
						...
						<a
							href="https://www.facebook.com/mnatravel.id/"
							target="_blank"
							class=" h-12 w-auto flex justify-end items-center hover:text-blue-700"
						>
						...
						<a
							href="https://www.tiktok.com/@mna.travel"
							target="_blank"
							class="h-12 w-auto flex justify-end items-center hover:text-blue-700"
						>
						...
						<a
							href="https://www.instagram.com/mna.travel/"
							target="_blank"
							class=" h-12 w-auto flex justify-end items-center hover:text-blue-700"
						>
							<svg
