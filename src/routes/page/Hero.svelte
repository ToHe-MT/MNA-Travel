...
>
	...
	<div class="absolute inset-0 bg-blue-700/0 z-10"></div>
	<div
		class="start text-white z-20 container flex flex-col gap-8 px-8 md:px-16 max-w-[1000px]"
	>
		<h1 class="text-[28px] sm:text-[30px] md:text-[35px] xl:text-[40px] syne">
		...
		<a
			...
			class="contact"
		>
			<button class="bg-blue-700 px-4 py-4 m-auto rounded-xl font-medium tracking-wide opensans">
				Daftar Sekarang
			</button>
		</a>
	</div>
